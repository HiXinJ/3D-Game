...
public class UFOFactory : MonoBehaviour
{
    ...
    public GameObject GetUFO(int round)
    {
        ...
        newUFO.GetComponent<UFOData>().gravity = Vector3.down*15f;
        newUFO.GetComponent<UFOData>().impulseForce=new Vector3(-11*round *dire, 2 * Random.Range(-round+0.5f, -round), 0);//根据轮数设置力的大小
